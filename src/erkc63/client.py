...
class ErkcClient:
    ...
    async def download_payment_data(
        ...
        *,
        ...
        """
        Загружает счет на оплату в формате PDF. Преобразует его и извлекает QR-коды
        оплаты (основной и капремонт) в изображения PNG и возвращает данные в объекте
        `AccrualData`.
    ...
    async def download_peni_data(
        ...
        *,
        ...
        """
        Загружает счет на оплату пени в формате PDF. Преобразует его и извлекает QR-коды
        оплаты в изображения PNG и возвращает данные в объекте `AccrualData`.
